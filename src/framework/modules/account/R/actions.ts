...
export class AccountActions {
    ...
    loginWithEmail(email, password, dispatch: boolean = true): Action {
        const action = {type: AccountActions.ACTION_LOGIN, payload: {email, password}};
    ...
    afterLogin(isOk, data, dispatch: boolean = true): Action {
        const action = {type: AccountActions.ACTION_AFTER_LOGIN, payload: {isOk, data}};
    ...
    userChange(user, dispatch: boolean = true): Action {
        const action = {type: AccountActions.ACTION_USER_CHANGE, payload: {user}};
    ...
    saveUser(user, dispatch: boolean = true): Action {
        const action = {type: AccountActions.ACTION_SAVE_USER, payload: {user}};
    ...
    afterLogout(isOk, data, dispatch: boolean = true): Action {
        const action = {type: AccountActions.ACTION_AFTER_LOGOUT, payload: {isOk, data}};
